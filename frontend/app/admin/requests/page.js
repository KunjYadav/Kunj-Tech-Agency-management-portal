      ...
      <div className='space-y-8'>
        <div className='flex flex-col md:flex-row md:items-center justify-between gap-4'>
          ...
          {(user.role === "client" || user.role === "admin") && (
            <Link
              href='/requests/new'
              className='bg-indigo-600 text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest flex items-center gap-2 hover:bg-slate-900 transition-all shadow-xl shadow-indigo-200 whitespace-nowrap'
            >
